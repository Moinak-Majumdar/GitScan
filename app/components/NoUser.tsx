...
const NoUser = () => {
    ...
    return (
        <section className="flex items-center justify-center flex-col-reverse md:flex-row mx-4 md:mx-10 lg:mx-16 xl:mx-36 2xl:mx-44 h-[100vh]">
            <div className="text-center md:text-left">
                <h2 style={inter.style} className="capitalize text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-500">discover github User Like never before</h2>
                ...
                <div className="">
                    ...
                    <div className="w-full flex flex-col items-center md:items-start">
                        ...
                        <button onClick={() => modalRef.current?.showModal()} className="relative inline-flex h-14 w-fit overflow-hidden rounded-full p-[1px] focus:outline-none mt-6 ">
                            ...
                            <span style={robotoMono.style} className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-200/75 dark:bg-slate-800/90 px-3 text-sm font-semibold text-blue-600 dark:text-slate-300 backdrop-blur-3xl">
                                Craft my Resume 🤖
                            </span>
                        </button>
                    </div>
            ...
            <Lottie animationData={searchUser} className='h-96 lg:h-[32rem]' />
        </section>
    )
