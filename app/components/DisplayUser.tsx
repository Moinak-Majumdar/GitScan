...
const DisplayUser = ({ userData }: { userData: GithubUser }) => {
  return (
    <section className='w-full flex justify-center items-center mt-24 lg:mt-0 p-4 md:p-10 lg:p-16 xl:p-36 2xl:p-44'>
      <div className='w-full flex flex-col lg:flex-row  lg:justify-evenly'>
        <div className=''>
          <Image src={userData.avatar} alt='Github avatar' width={250} height={250} className='rounded-full p-2 border border-blue-600 mx-auto' />
          <p style={robotoMono.style} className="text-xs text-center mt-12  w-full text-slate-700 dark:text-slate-300">
